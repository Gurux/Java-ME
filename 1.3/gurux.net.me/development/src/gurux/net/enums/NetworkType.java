...
public class NetworkType {
     ...
     * UDP protocol.
     */
    public static NetworkType UDP = new NetworkType(0);

    /**
     * TCP/IP protocol.
     */
    public static NetworkType TCP = new NetworkType(1);
     ...
     */
    public static NetworkType forValue(int value) {
        return (NetworkType) getMappings().get(new Integer(value));
    }
}