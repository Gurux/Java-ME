 ...
 * @author Gurux Ltd.
 */
public class StartProtocolType {
    /**
     * IEC protocol is start protocol.
     */
    public static final StartProtocolType IEC = new StartProtocolType(0, "IEC");

    /**
     * DLMS is start protocol.
     */
    public static final StartProtocolType DLMS = new StartProtocolType(1, "DLMS");
	 ...
	 */
	private StartProtocolType(int value, String name) {
		this.value = value;
		this.name = name;
	...
	private static java.util.Hashtable getMappings() {
		synchronized (StartProtocolType.class) {
			if (mappings == null) {
	 ...
	 */
	public static StartProtocolType forValue(int value) {
		return (StartProtocolType) getMappings().get(new Integer(value));
	}
