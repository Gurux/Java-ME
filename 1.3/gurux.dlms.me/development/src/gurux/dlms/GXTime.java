...
public class GXTime extends GXDateTime {
	...
	public GXTime() {
		super();
		getSkip().addElement(DateTimeSkips.YEAR);
		getSkip().addElement(DateTimeSkips.MONTH);
		getSkip().addElement(DateTimeSkips.DAY);
		getSkip().addElement(DateTimeSkips.DAY_OF_WEEK);
	}
