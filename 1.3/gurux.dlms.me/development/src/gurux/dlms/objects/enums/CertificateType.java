...
public class CertificateType {
	 ...
	 */
	public static final CertificateType DIGITAL_SIGNATURE = new CertificateType(
			0, "DIGITAL_SIGNATURE");

	/**
	 * Certificate type is key agreement.
	 */
	public static final CertificateType KEY_AGREEMENT = new CertificateType(1,
			"KEY_AGREEMENT");

	/**
	 * Certificate type is TLS.
	 */
	public static final CertificateType TLS = new CertificateType(2, "TLS");

	/**
	 * Certificate type is other.
	 */
	public static final CertificateType OTHER = new CertificateType(3, "OTHER");
	 ...
	 */
	private CertificateType(int value, String name) {
		this.value = value;
		this.name = name;
	...
	public static CertificateType forValue(int value) {
		return (CertificateType) getMappings().get(new Integer(value));
	}
