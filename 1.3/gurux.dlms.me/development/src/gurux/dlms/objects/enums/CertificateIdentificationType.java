 ...
 * the certificate.
 */
public class CertificateIdentificationType {
	/**
	 * Certificate is identified with entity identification.
	 */
	public static final CertificateIdentificationType ENTITY = new CertificateIdentificationType(
			0, "ENTITY");

	/**
	 * Certificate is identified with serial number of the certificate.
	 */
	public static final CertificateIdentificationType SERIAL = new CertificateIdentificationType(
			1, "SERIAL");
	 ...
	 */
	private CertificateIdentificationType(int value, String name) {
		this.value = value;
		this.name = name;
	 ...
	 */
	public static CertificateIdentificationType forValue(int value) {
		return (CertificateIdentificationType) getMappings()
