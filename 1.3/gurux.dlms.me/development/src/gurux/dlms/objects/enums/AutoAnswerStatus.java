...
public class AutoAnswerStatus {
	public static final AutoAnswerStatus INACTIVE = new AutoAnswerStatus(0,
			"INACTIVE");
	public static final AutoAnswerStatus ACTIVE = new AutoAnswerStatus(1,
			"ACTIVE");

	public static final AutoAnswerStatus LOCKED = new AutoAnswerStatus(2,
			"LOCKED");
	 ...
	 */
	private AutoAnswerStatus(int value, String name) {
		this.value = value;
		this.name = name;
	...
	public static AutoAnswerStatus forValue(int value) {
		return (AutoAnswerStatus) getMappings().get(new Integer(value));
	}
