...
public class PppAuthenticationType {
	 ...
	 * No authentication.
	 */
	public static final PppAuthenticationType NONE = new PppAuthenticationType(
			0, "NONE");

	/**
	 * PAP Login
	 */
	public static final PppAuthenticationType PAP = new PppAuthenticationType(1,
			"PAP");

	/**
	 * CHAP-algorithm
	 */
	public static final PppAuthenticationType CHAP = new PppAuthenticationType(
			2, "CHAP");
	 ...
	 */
	private PppAuthenticationType(int value, String name) {
		this.value = value;
		this.name = name;
	...
	public static PppAuthenticationType forValue(int value) {
		return (PppAuthenticationType) getMappings().get(new Integer(value));
	}
