...
public class GXDLMSSchedule extends GXDLMSObject implements IGXDLMSBase {
	 ...
	 */
	public final Vector getEntries() {
		return entries;
	}
	 ...
	 */
	public final void setEntries(final Vector value) {
		entries = value;
	}
