...
public class GXDLMSDisconnectControl extends GXDLMSObject
	...
	public final Object getValue(final GXDLMSSettings settings,
		...
		if (e.getIndex() == 3) {
			return new Integer(getControlState().getValue());
		}
		if (e.getIndex() == 4) {
			return new Integer(getControlMode().getValue());
		}
	...
	public final void setValue(final GXDLMSSettings settings,
		...
		if (e.getIndex() == 1) {
			...
			if (e.getValue() == null) {
				...
				setControlState(
						ControlState.forValue(GXCommon.intValue(e.getValue())));
			}
			...
			if (e.getValue() == null) {
				...
				setControlMode(
						ControlMode.forValue(GXCommon.intValue(e.getValue())));
			}
