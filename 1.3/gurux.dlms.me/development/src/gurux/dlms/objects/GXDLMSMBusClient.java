...
public class GXDLMSMBusClient extends GXDLMSObject implements IGXDLMSBase {
	...
	private Vector captureDefinition;
	...
	public final Vector getCaptureDefinition() {
	...
	public final int[] getAttributeIndexToRead() {
		...
		// Alarm
		if (canRead(12)) {
			attributes.addElement(new Integer(12));
		}
	...
	public final void setValue(final GXDLMSSettings settings,
		...
		if (e.getIndex() == 1) {
			...
			captureDefinition.removeAllElements();
			if (e.getValue() != null) {
				...
				for (int pos = 0; pos != arr.length; ++pos) {
					...
					captureDefinition.addElement(new GXSimpleEntry(
			...
			primaryAddress = GXCommon.intValue(e.getValue());
		} else if (e.getIndex() == 6) {
			identificationNumber = GXCommon.intValue(e.getValue());
		} else if (e.getIndex() == 7) {
			manufacturerID = GXCommon.intValue(e.getValue());
		} else if (e.getIndex() == 8) {
			dataHeaderVersion = GXCommon.intValue(e.getValue());
		} else if (e.getIndex() == 9) {
			deviceType = GXCommon.intValue(e.getValue());
		} else if (e.getIndex() == 10) {
			accessNumber = GXCommon.intValue(e.getValue());
		} else if (e.getIndex() == 11) {
			status = GXCommon.intValue(e.getValue());
		} else if (e.getIndex() == 12) {
			alarm = GXCommon.intValue(e.getValue());
		} else {
			e.setError(ErrorCode.READ_WRITE_DENIED);
		}
	}
