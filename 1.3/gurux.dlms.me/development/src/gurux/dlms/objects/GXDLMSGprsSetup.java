...
public class GXDLMSGprsSetup extends GXDLMSObject implements IGXDLMSBase {
	...
	public final void setValue(final GXDLMSSettings settings,
		...
		if (e.getIndex() == 1) {
			...
			setPINCode(GXCommon.intValue(e.getValue()));
		} else if (e.getIndex() == 4) {
			Object[] arr = (Object[]) ((Object[]) e.getValue())[0];
			defaultQualityOfService.setPrecedence(GXCommon.intValue(arr[0]));
			defaultQualityOfService.setDelay(GXCommon.intValue(arr[1]));
			defaultQualityOfService.setReliability(GXCommon.intValue(arr[2]));
			defaultQualityOfService
					.setPeakThroughput(GXCommon.intValue(arr[3]));
			defaultQualityOfService
					.setMeanThroughput(GXCommon.intValue(arr[4]));
			arr = (Object[]) ((Object[]) e.getValue())[1];
			requestedQualityOfService.setPrecedence(GXCommon.intValue(arr[0]));
			requestedQualityOfService.setDelay(GXCommon.intValue(arr[1]));
			requestedQualityOfService.setReliability(GXCommon.intValue(arr[2]));
