...
public class GXDLMSHdlcSetup extends GXDLMSObject implements IGXDLMSBase {
	...
	public final void setValue(final GXDLMSSettings settings,
		...
		if (e.getIndex() == 1) {
			...
			windowSizeTransmit = GXCommon.intValue(e.getValue());
		} else if (e.getIndex() == 4) {
			windowSizeReceive = GXCommon.intValue(e.getValue());
		} else if (e.getIndex() == 5) {
			maximumInfoLengthTransmit = GXCommon.intValue(e.getValue());
		} else if (e.getIndex() == 6) {
			maximumInfoLengthReceive = GXCommon.intValue(e.getValue());
		} else if (e.getIndex() == 7) {
			interCharachterTimeout = GXCommon.intValue(e.getValue());
		} else if (e.getIndex() == 8) {
			inactivityTimeout = GXCommon.intValue(e.getValue());
		} else if (e.getIndex() == 9) {
			deviceAddress = GXCommon.intValue(e.getValue());
		} else {
			e.setError(ErrorCode.READ_WRITE_DENIED);
		}
	}
