...
public class GXDLMSSNSettings {
	...
	public final void setGeneralProtection(final boolean value) {
		getConformanceBlock()[1] = GXCommon.setBits(getConformanceBlock()[0],
				0x40, value);
	}
	...
	public final void setRead(final boolean value) {
		conformanceBlock[0] = GXCommon.setBits(conformanceBlock[0], 0x10,
				value);
	}
	...
	public final void setReadBlockTransfer(final boolean value) {
		getConformanceBlock()[1] = GXCommon.setBits(getConformanceBlock()[1],
				0x10, value);
	}
	...
	public final void setDataNotification(final boolean value) {
		getConformanceBlock()[2] = GXCommon.setBits(getConformanceBlock()[2],
				0x80, value);
	}
	...
	public final void setParameterizedAccess(final boolean value) {
		conformanceBlock[2] = GXCommon.setBits(conformanceBlock[2], 0x20,
				value);
	}
