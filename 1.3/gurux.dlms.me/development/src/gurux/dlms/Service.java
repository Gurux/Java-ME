...
public class Service {
	 ...
	 * Other error.
	 */
	public static final Service OTHER = new Service(0, "OTHER");
	/**
	 * PDU size is wrong.
	 */
	public static final Service PDU_SIZE = new Service(1, "PDU_SIZE");
	/**
	 * Service is unsupported.
	 */
	public static final Service UNSUPPORTED = new Service(2, "UNSUPPORTED");
	 ...
	 */
	private Service(int value, String name) {
		this.value = value;
		this.name = name;
	...
	public static Service forValue(int value) {
		return (Service) getMappings().get(new Integer(value));
	}
