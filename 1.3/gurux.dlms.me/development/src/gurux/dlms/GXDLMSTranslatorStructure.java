...
public class GXDLMSTranslatorStructure {
	...
	public final String getDataType(final DataType type) {
		return (String) tags
				.get(new Integer(GXDLMS.DATA_TYPE_OFFSET + type.getValue()));
	}
	 ...
	 *            Amount of spaces.
	 */
	private static void appendSpaces(final StringBuffer sb, final int count) {
	...
	public final void appendLine(final int tag, final String name,
			final String value) {
		String tmp = (String) tags.get(new Integer(tag));
		if (tmp == null) {
	...
	public final void append(final int tag, final boolean start) {
		...
		sb.append((String) tags.get(new Integer(tag)));
		sb.append('>');
	}

	public final void appendStartTag(final int tag, final String name,
			final String value) {
		appendStartTag((String) tags.get(new Integer(tag)), name, value);
	}
	...
	public final void appendEndTag(final int tag) {
		appendEndTag((String) tags.get(new Integer(tag)));
	}
	...
	public final String integerToHex(final long value, final int desimals) {
		if (showNumericsAsHex
			...
			return GXCommon.integerToHex(new Long(value), desimals);
		}
