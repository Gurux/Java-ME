...
public class InterfaceType {
	 ...
	 */
	public static final InterfaceType HDLC = new InterfaceType(0, "HDLC");
	/**
	 * The interface type is WRAPPER, can be used with devices that support IEC
	 * 62056-47.
	 */
	public static final InterfaceType WRAPPER = new InterfaceType(1, "WRAPPER");
	/**
	 * Only PDU is get.
	 */
	public static final InterfaceType PDU = new InterfaceType(2, "PDU");
	...
	private static java.util.Hashtable getMappings() {
		synchronized (InterfaceType.class) {
			if (mappings == null) {
	...
	public static InterfaceType forValue(int value) {
		return (InterfaceType) getMappings().get(new Integer(value));
	}
