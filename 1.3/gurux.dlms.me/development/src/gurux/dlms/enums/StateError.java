...
public class StateError {
	 ...
	 */
	public static final StateError SERVICE_NOT_ALLOWED = new StateError(1,
			"SERVICE_NOT_ALLOWED");

	/**
	 * Unknown service.
	 */
	public static final StateError SERVICE_UNKNOWN = new StateError(2,
			"SERVICE_UNKNOWN");
	 ...
	 */
	private StateError(int value, String name) {
		this.value = value;
		this.name = name;
	...
	public static StateError forValue(int value) {
		return (StateError) getMappings().get(new Integer(value));
	}
