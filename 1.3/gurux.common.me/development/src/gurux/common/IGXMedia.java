 ...
 * <p>
 * Using this interface GXCommunication library enables communication with different medias.
 * </p>
 * 
 * @author Gurux Ltd.
 */
public interface IGXMedia {
  ...
  /**
   * Returns name of the media. Media name is used to identify media connection, so two different
   * media connection can not return same media name.
   * 
   * @return Media name.
   */
  String getName();
  ...
  /**
   * Sends data asynchronously. No reply from the receiver, whether or not the operation was
   ...
   */
  boolean receive(ReceiveParameters args);
  ...
  /**
   * Validate Media settings for connection open. Returns table of media properties that must be set
   * before media is valid to open.
   */
  void validate();
