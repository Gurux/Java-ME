...
public class ReceiveParameters {
  ...
  /**
   * The end of packet (EOP) waited for. The EOP can, for example be a single byte ('0xA1'), a
   * string ("OK") or an array of bytes.
   * 
  ...
  /**
   * Maximum time, in milliseconds, to wait for reply data. WaitTime -1 (Default value) indicates
   * infinite wait time.
   * 
