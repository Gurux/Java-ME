...
public class ReceiveParameters<T> {
     ...
     *            Reply type.
     */
    public ReceiveParameters(final Class type) {
        replyType = type;
        setPeek(false);
        setWaitTime(-1);
    }
    ...
    /**
     * The end of packet (EOP) waited for. The EOP can, for example be a single
     * byte ('0xA1'), a string ("OK") or an array of bytes.
     * 
     ...
     */
    public final Class getReplyType() {
        return replyType;
    }
}