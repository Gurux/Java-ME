...
public class GXSynchronousMediaBase {
    ...
    public static byte[] getAsByteArray(final Object value) {
        ...
        if (value instanceof Short) {
            return ByteBuffer.allocateDirect(GXCommon.SHORT_BYTES)
                    .putInt(((Short) value).shortValue()).array();
        }

        if (value instanceof Integer) {
            return ByteBuffer.allocateDirect(GXCommon.INTEGER_BYTES)
                    .putInt(((Integer) value).intValue()).array();
        }
     ...
     */
    public static Object byteArrayToObject(final byte[] value,
        ...
        if (type == Character.class || type == char.class) {
            return new java.lang.Character((char) value[0]);
        }
                ...
                if (args.getReply() instanceof String) {
                    ...
                    if (newArray != null) {
                        ...
                        System.arraycopy((byte[]) args.getReply(), 0, arr, 0,
                                oldReplySize);
                        // Copy new values.
                        System.arraycopy(newArray, 0, arr, oldReplySize,
                                newArray.length);
                        args.setReply(arr);
                    }
                } else {
