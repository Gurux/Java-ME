...
public class GXDLMSAssociationShortName extends GXDLMSObject
    ...
    final void updateAccessRights(final Object[] buff) {
        for (Object access : buff) {
            ...
            int sn = ((Number) it[0]).intValue();
            GXDLMSObject obj = objectList.findBySN(sn);
            if (obj != null) {
                for (Object attributeAccess : (Object[]) it[1]) {
                    int id = ((Number) ((Object[]) attributeAccess)[0])
                            .intValue();
                ...
                for (Object methodAccess : (Object[]) it[2]) {
        ...
        if (e.getIndex() == 1) {
            ...
            if (e.getValue() != null) {
                for (Object it : (Object[]) e.getValue()) {
                    ...
                    int sn = ((Number) item[0]).intValue() & 0xFFFF;
                    ObjectType type =
                            ObjectType.forValue(((Number) item[1]).intValue());
                    int version = ((Number) item[2]).intValue();
