...
public class GXDLMSSecuritySetup extends GXDLMSObject implements IGXDLMSBase {
    ...
    public final void setSecurityPolicy(final SecurityPolicy value) {
        if (value == SecurityPolicy.NOTHING
                || value == SecurityPolicy.AUTHENTICATED
                || value == SecurityPolicy.ENCRYPTED
                || value == SecurityPolicy.AUTHENTICATED_ENCRYPTED) {
    ...
    public final byte[][] activate(final GXDLMSClient client,
        ...
        return client.method(this, 1, new Integer(security.ordinal()),
                DataType.ENUM);
    }
