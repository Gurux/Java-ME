...
public class GXDLMSAssociationLogicalName extends GXDLMSObject
    ...
    static final void updateAccessRights(final GXDLMSObject obj,
        ...
        if (buff != null && buff.length != 0) {
            for (Object access : (Object[]) buff[0]) {
            ...
            for (Object access : (Object[]) buff[1]) {
    ...
    static void updateObjectList(final GXDLMSSettings settings,
        ...
        if (value != null) {
            for (Object it : (Object[]) value) {
                ...
                ObjectType type =
                        ObjectType.forValue(((Number) item[0]).intValue());
                int version = ((Number) item[1]).intValue();
    ...
    private void updateApplicationContextName(final Object value) {
        ...
        if (value instanceof byte[]) {
            ...
            if (value != null) {
                ...
                applicationContextName
                        .setJointIsoCtt(((Number) arr[0]).intValue());
                applicationContextName.setCountry(((Number) arr[1]).intValue());
                applicationContextName
                        .setCountryName(((Number) arr[2]).intValue());
                applicationContextName.setIdentifiedOrganization(
                        ((Number) arr[3]).intValue());
                applicationContextName.setDlmsUA(((Number) arr[4]).intValue());
                applicationContextName
                        .setApplicationContext(((Number) arr[5]).intValue());
                applicationContextName
                        .setContextId(((Number) arr[6]).intValue());
            }
        }
    }
            ...
            if (value instanceof byte[]) {
                ...
                if (value != null) {
                    ...
                    authenticationMechanismMame
                            .setJointIsoCtt(((Number) arr[0]).intValue());
                    authenticationMechanismMame
                            .setCountry(((Number) arr[1]).intValue());
                    authenticationMechanismMame
                            .setCountryName(((Number) arr[2]).intValue());
                    authenticationMechanismMame.setIdentifiedOrganization(
                            ((Number) arr[3]).intValue());
                    authenticationMechanismMame
                            .setDlmsUA(((Number) arr[4]).intValue());
                    authenticationMechanismMame.setAuthenticationMechanismName(
                            ((Number) arr[5]).intValue());
                    authenticationMechanismMame.setMechanismId(Authentication
                            .forValue(((Number) arr[6]).intValue()));
                }
            }
        }
    }
    ...
    public final void setValue(final GXDLMSSettings settings,
        ...
        case 3:
            if (e.getValue() != null) {
                ...
                clientSAP = ((Number) arr[0]).shortValue();
                serverSAP = ((Number) arr[1]).shortValue();
            }
            break;
        case 4:
        ...
        case 5:
            if (e.getValue() != null) {
                ...
                xDLMSContextInfo
                        .setMaxReceivePduSize(((Number) arr[1]).intValue());
                xDLMSContextInfo
                        .setMaxSendPpuSize(((Number) arr[2]).intValue());
                xDLMSContextInfo
                        .setDlmsVersionNumber(((Number) arr[3]).intValue());
                xDLMSContextInfo
                        .setQualityOfService(((Number) arr[4]).intValue());
