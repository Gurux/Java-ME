...
public enum Authentication {
    ...
    public String toString() {
        ...
        if (value == Authentication.HIGH) {
            str = "High";
        } else if (value == Authentication.HIGH_GMAC) {
            str = "HighGMac";
        } else if (value == Authentication.HIGH_MD5) {
            str = "HighMd5";
        } else if (value == Authentication.HIGH_SHA1) {
            str = "HighSha1";
        } else if (value == Authentication.LOW) {
            str = "Low";
        } else if (value == Authentication.NONE) {
            str = "None";
        } else {
            str = "";
        }
