...
class GXStandardObisCodeCollection
        implements java.util.List<GXStandardObisCode> {
    private List<GXStandardObisCode> base = new ArrayList<GXStandardObisCode>();
        ...
        for (GXStandardObisCode it : this) {
            ...
            if (equalsInterface(it, ic)
                ...
                if (obisCode != null) {
                    ...
                    desc = GXCommon.replaceAll(desc, "$A",
                            Integer.toString(obisCode[0]));
                    desc = GXCommon.replaceAll(desc, "$B",
                            Integer.toString(obisCode[1]));
                    desc = GXCommon.replaceAll(desc, "$C",
                            Integer.toString(obisCode[2]));
                    desc = GXCommon.replaceAll(desc, "$D",
                            Integer.toString(obisCode[3]));
                    desc = GXCommon.replaceAll(desc, "$E",
                            Integer.toString(obisCode[4]));
                    desc = GXCommon.replaceAll(desc, "$F",
                            Integer.toString(obisCode[5]));
                    // Increase value
    ...
    @Override
    public boolean add(GXStandardObisCode e) {
        return base.add(e);
    }

    @Override
    public void add(int index, GXStandardObisCode element) {
        base.add(index, element);
    }

    @Override
    public boolean addAll(Collection<? extends GXStandardObisCode> c) {
        return base.addAll(c);
    }

    @Override
    public boolean addAll(int index,
            Collection<? extends GXStandardObisCode> c) {
    ...
    @Override
    public GXStandardObisCode get(int index) {
    ...
    @Override
    public Iterator<GXStandardObisCode> iterator() {
    ...
    @Override
    public ListIterator<GXStandardObisCode> listIterator() {
        return base.listIterator();
    }

    @Override
    public ListIterator<GXStandardObisCode> listIterator(int index) {
    ...
    @Override
    public GXStandardObisCode remove(int index) {
    ...
    @Override
    public GXStandardObisCode set(int index, GXStandardObisCode element) {
    ...
    @Override
    public List<GXStandardObisCode> subList(int fromIndex, int toIndex) {
